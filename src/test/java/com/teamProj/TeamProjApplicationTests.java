...
class TeamProjApplicationTests {
    ...
    @Autowired
    FairParticipantDao fairParticipantDao;
    ...
    @Autowired
    MarkedRecruitmentInfoDao markedRecruitmentInfoDao;
    ...
    void getAllMarkedRecruitmentInfo() {
        List<MarkedRecruitmentInfo> markedRecruitmentInfoList = markedRecruitmentInfoDao.selectList(null);
